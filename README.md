...
|                        | Mon                                                      | Tue                                                       | Wed                                                                           | Thu                                                   | Fri                                              |
| ---------------------- | -------------------------------------------------------- | --------------------------------------------------------- | ----------------------------------------------------------------------------- | ----------------------------------------------------- | ------------------------------------------------ |
| **Lecture**            | - The Problem of Delivering Software <br>Video: HGOP 1 and HGOP 2(09:53 - 1:07) <br> 10:00 Introduction and Q&A (https://eu01web.zoom.us/j/68303049072) | - Configuration Management <br>Video: HGOP 2 (1:12 - 2:12), HGOP 3 <br> 11:00 Q&A (Zoom) | - Build and Deployment Scripting <br> - Advanced Version Control <br>Video: HGOP 3 () | - The Anatomy of the Build Pipeline <br>Video: HGOP 4()                   | No lecture, Lab day                              |
