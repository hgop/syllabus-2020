...
|                        | Mon                                                            | Tue                                                                  | Wed                                               | Thu                               | Fri                                                |
| ---------------------- | -------------------------------------------------------------- | -------------------------------------------------------------------- | ------------------------------------------------- | --------------------------------- | -------------------------------------------------- |
| **Lecture**            | - Deploying and Releasing Applications<br>- Managing Data<br>11:00 Q&A [Zoom](https://eu01web.zoom.us/j/68392394252) | [Mobile App Deployment](https://youtu.be/LbNDzrHXaI8) <br> Accessibility<br>Usability<br>11:00 Q&A [Zoom](https://eu01web.zoom.us/j/65145305304) | - Managing Continuous Delivery<br> Team Topology<br> 10:00 Guest lecture on compliance [Zoom]() | Time for students to prepare exam | Exam, 09:00 - 10:30                                |
